...
class _TvDetailPageState extends State<TvDetailPage> {
  ...
  void initState() {
    ...
    context.read<TvDetailBloc>().add(FetchTvRecommendation(widget.id));
    super.initState();
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      if (!isAddedWatchlist) {
                        context.read<TvDetailBloc>().add(AddTvWatchlist(tv));
                      } else {
                        context.read<TvDetailBloc>().add(DeleteTvWatchlist(tv));
                      }
                    },
                    child: Row(
