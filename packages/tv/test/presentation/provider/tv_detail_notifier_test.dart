...
void main() {
  ...
  setUp(() {
    ...
    provider = TvDetailNotifier(
      getTvDetail: mockGetTvDetail as GetTvDetail,
      getTvRecommendations: mockGetTvRecommendations as GetTvRecommendations,
      getWatchListStatus: mockGetWatchlistStatus as GetWatchListTvStatus,
