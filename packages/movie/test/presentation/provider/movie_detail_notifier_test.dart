...
void main() {
  ...
  setUp(() {
    ...
    provider = MovieDetailNotifier(
      getMovieDetail: mockGetMovieDetail as GetMovieDetail,
      getMovieRecommendations: mockGetMovieRecommendations as GetMovieRecommendations,
      getWatchListStatus: mockGetWatchlistStatus as GetWatchListMovieStatus,
