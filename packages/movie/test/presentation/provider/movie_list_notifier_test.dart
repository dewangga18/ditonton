...
void main() {
  ...
  setUp(() {
    ...
    provider = MovieListNotifier(
      getNowPlayingMovies: mockGetNowPlayingMovies as GetNowPlayingMovies,
      getPopularMovies: mockGetPopularMovies as GetPopularMovies,
      getTopRatedMovies: mockGetTopRatedMovies as GetTopRatedMovies,
    )..addListener(() {
        listenerCallCount += 1;
      });
  });
